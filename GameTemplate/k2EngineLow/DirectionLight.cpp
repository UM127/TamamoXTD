...
namespace nsK2EngineLow {
	...
	void DirectionLight::Init()
	{
		...
		//ポイントライトの影響範囲を設定する
		m_light.m_pointLig.ptRange = 0.0f;
		...
		*/
		...
		//射出角度は25度。
		m_light.m_spotLig.spAngle = Math::DegToRad(50.0f);
	}
	...
	void DirectionLight::Update()
	{
		...
		g_Lig.SetSpotDir(m_light.m_spotLig.spDirection);//スポットライトの方向を設定
	}
}